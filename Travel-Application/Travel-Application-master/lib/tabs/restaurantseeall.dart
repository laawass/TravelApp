...
class Seealltabrestaurant extends StatefulWidget {
  @override
  _SeealltabrestaurantState createState() => new _SeealltabrestaurantState();
}

class _SeealltabrestaurantState extends State<Seealltabrestaurant> {
                ...
                children: <Widget>[
                  ...
                  Expanded(
                      child: StreamBuilder<QuerySnapshot>(
                          stream: (searchString == null || searchString.trim() == "")? Firestore.instance.collection("Restaurant").snapshots():
                          Firestore.instance.collection("Restaurant").where("searchIndex",arrayContains: searchString).snapshots(),
